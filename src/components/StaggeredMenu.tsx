    ...
    (e: React.MouseEvent<HTMLAnchorElement>, link: string) => {
      ...
      setTimeout(() => {
        if (link.startsWith("#")) {
          ...
          const SECTION_IDS = ["hero", "caffeine", "wiiings", "stats", "heritage", "fuel", "cta", "author"];
          const index = SECTION_IDS.indexOf(id);
          if (index !== -1) {
            const totalScroll = document.documentElement.scrollHeight - window.innerHeight;
            const target = (index / (SECTION_IDS.length - 1)) * totalScroll;
          ...
          <div className="sm-panel-inner flex-1 flex flex-col gap-5">
            ...
            {displaySocials &&
              ...
              socialItems.length > 0 && (
                ...
                >
                  <h3 className="sm-socials-title m-0 text-base font-medium text-[var(--rb-red)]">
                    Socials
                  </h3>
                  <ul
                    ...
                    {socialItems.map((s, i) => (
                      <li key={s.label + i} className="sm-socials-item">
                        <a
                          ...
                          className="sm-socials-link text-[1.2rem] font-medium text-white/70 no-underline relative inline-block py-[2px] transition-[color,opacity] duration-300 ease-linear"
                        >
                          {s.label}
                        </a>
                      </li>
